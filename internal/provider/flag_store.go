...
func PopulateFlagValues() {
	...
	FloatFlagValues["special_ability_buff_perc"] = FloatFlagValue{FlagKey: "special_ability_buff_perc", FlagValue: float64(0.23456)}
	IntFlagValues["num_of_special_abilities"] = IntFlagValue{FlagKey: "num_of_special_abilities", FlagValue: int64(12)}
}
